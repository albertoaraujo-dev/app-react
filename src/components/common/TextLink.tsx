...
const StyledTextLink = styled.a`
  ...
  color: ${(props: StyledProps) =>
    getTextLinkStyles('content', props.type, props.theme)};
  outline: none;
  ...
  &:hover {
    color: ${(props) =>
      getTextLinkStyles('contentHover', props.type, props.theme)};
  }
  ...
  &:focus {
    ...
    background-color: ${(props) =>
      getTextLinkStyles('backgroundActive', props.type, props.theme)};
    border-radius: 4px;
  }
`;
